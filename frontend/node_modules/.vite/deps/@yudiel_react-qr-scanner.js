...
function qt(o) {
	switch (o) {
		case "Linear-Codes": return Ma.reduce((l, d) => l | qt(d), 0);
		case "Matrix-Codes": return Aa.reduce((l, d) => l | qt(d), 0);
		case "Any": return (1 << Dt.length) - 1;
		case "None": return 0;
		default: return 1 << Mt.indexOf(o);
	}
}
function Fa(o) {
	if (o === 0) return "None";
	return Mt[31 - Math.clz32(o)];
}
function Ra(o) {
...
async function Ya(o, l, d = It) {
	const b = {
		...It,
		...d
	}, f = await Xe(o, { fireImmediately: !0 });
	let I, D;
	if ("width" in l && "height" in l && "data" in l) {
		...
		else if ("size" in l) [_, A] = [l.size, new Uint8Array(await l.arrayBuffer())];
...
async function Zt(o = {}) {
	...
	!((d = globalThis.process) === null || d === void 0 || (d = d.versions) === null || d === void 0) && d.node && ((b = globalThis.process) === null || b === void 0 || b.type);
	...
	var mt = (t) => Oe(t), Rt = (t) => {
		...
		throw new Ft(t).init(e, r), H = t, vt++, H;
	}, Tr = () => vt, Er = (t) => {
		throw H || (H = t), H;
	}, Pr = () => At(""), gt = {}, Lt = (t) => {
		for (; t.length;) {
	...
	function j(t, e) {
		return Sr(t, e, arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {});
	}
	var Ir = (t, e, r, n) => {
		e = F(e), j(t, {
			name: e,
		...
		Object.assign(t, {
			...
			clone() {
				...
				var r = ut(Object.create(Object.getPrototypeOf(this), { $$: { value: Dr(this.$$) } }));
	...
	function $t() {}
	var Ut = (t, e) => Object.defineProperty(e, "name", { value: t }), ue = {}, ce = (t, e, r) => {
	...
	var fe = (t, e, r) => {
		...
		return !!e.smartPtrType !== !!e.smartPtr && bt("Both smartPtrType and smartPtr must be specified"), e.count = { value: 1 }, ut(Object.create(t, { $$: {
			value: e,
			writable: !0
		} }));
	};
	function Nr(t) {
		...
		var s = ue[this.registeredClass.getActualType(e)];
	...
	var pe = (t) => {
		...
		le(P, function() {
			...
			}), K = Object.create(O, { constructor: { value: E } });
			E.prototype = K;
	...
	var Jr = (t, e, r, n, a, i) => {
		...
		switch (e) {
			case 1: return r ? (n) => Y[n] : (n) => W[n];
			case 2: return r ? (n) => dt[n >> 1] : (n) => at[n >> 1];
			case 4: return r ? (n) => ot[n >> 2] : (n) => T[n >> 2];
	...
	}, un = Object.assign({ optional: !0 }, me), cn = (t, e) => {
		j(t, un);
	}, ln = (t, e, r, n) => {
		if (!(n > 0)) return 0;
		...
		for (var e = 0, r = 0; r < t.length; ++r) t.codePointAt(r) > 65535 && r++, e += 4;
		return e;
	}, wn = (t, e, r) => {
		r = F(r);
		var n, a, i;
		...
		return Tn(Ut(`methodCaller<(${i.map((y) => y.name)}) => ${a.name}>`, h));
		...
		var r = (t - Pt.buffer.byteLength + 65535) / 65536 | 0;
		try {
		...
		for (var n = 1; n <= 4; n *= 2) {
			...
			if (Ln(Math.min(r, Rn(Math.max(t, a), 65536)))) return !0;
		}
		return !1;
		...
		for (var a of ct()) {
			var i = e + r;
			T[t + n >> 2] = i, r += rt(a, i, Infinity) + 1, n += 4;
		}
		return 0;
	}, Vn = (t, e) => {
		var r = ct();
...
var Ye = [
	...
	["any", "Any"]
], Qa = [...Ye, ["unknown"]].map((o) => o[0]), Yt = new Map(Ye);
function Ja(o) {
...
function Ge(o, l) {
	return fo(o) ? new DOMException(`${l}: ${o.message}`, o.name) : ho(o) ? new o.constructor(`${l}: ${o.message}`) : /* @__PURE__ */ new Error(`${l}: ${o}`);
}
function fo(o) {
...
function h(A, o) {
	A.forEach((A) => {
		...
		o.beginPath(), o.moveTo(C + 8, c), o.lineTo(C + E - 8, c), o.quadraticCurveTo(C + E, c, C + E, c + 8), o.lineTo(C + E, c + h - 8), o.quadraticCurveTo(C + E, c + h, C + E - 8, c + h), o.lineTo(C + 8, c + h), o.quadraticCurveTo(C, c + h, C, c + h - 8), o.lineTo(C, c + 8), o.quadraticCurveTo(C, c, C + 8, c), o.closePath(), o.fillStyle = "rgba(255, 255, 0, 0.9)", o.fill(), B.forEach((A, g) => {
			...
			let w = t - r / 2, a = 0;
			const s = [...A.matchAll(/"([^"]+)":/g)], C = [...A.matchAll(/:\s*("[^"]*"|\d+|true|false|null)/g)];
			s.forEach((g, t) => {
...
function T(A) {
	const { scanning: o, startScanning: i, stopScanning: e } = A, [w, n] = (0, import_react.useState)(!1);
	function a() {
	...
	return (0, import_jsx_runtime.jsx)("div", {
		...
		children: (0, import_jsx_runtime.jsx)(o ? D : F, {
			disabled: w,
			onClick: a
		})
	});
...
function Q(A) {
	...
	return i && t ? (0, import_jsx_runtime.jsx)("div", {
		style: {
			bottom: 35,
			right: 8,
			position: "absolute",
		...
		children: o ? (0, import_jsx_runtime.jsx)(m, { onClick: () => e(!1) }) : (0, import_jsx_runtime.jsx)(V, { onClick: () => e(!0) })
	}) : null;
}
function R(A) {
	...
	return (0, import_jsx_runtime.jsx)("div", {
		...
		children: (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				e && (0, import_jsx_runtime.jsx)(T, {
					scanning: i,
					startScanning: a,
					stopScanning: B
				}),
				w && t.torch && (0, import_jsx_runtime.jsx)(Q, {
					scanning: i,
					status: w.status,
					torchToggle: w.toggle
				}),
				n && t.zoom && (0, import_jsx_runtime.jsx)(N, {
					scanning: i,
					capabilities: t.zoom,
					value: n.value,
					onZoom: n.onChange
...
function k(n) {
	const { onScan: c, constraints: E, formats: h = ["any"], paused: q = !1, components: M, children: l, styles: I, classNames: G, allowMultiple: D, scanDelay: F, onError: T, sound: m } = n, V = (0, import_react.useRef)(null), Q = (0, import_react.useRef)(null), R = (0, import_react.useRef)(null), d = (0, import_react.useMemo)(() => ({
		...r,
		...E
	}), [E]), N = (0, import_react.useMemo)(() => ({
		...B,
		...M
	}), [M]), [f, k] = (0, import_react.useState)(!1), [y, K] = (0, import_react.useState)(!0), [L, J] = (0, import_react.useState)(d), x = function() {
		const A = (0, import_react.useRef)(Promise.resolve({
			type: "stop",
			data: {}
		})), o = (0, import_react.useRef)(null), g = (0, import_react.useRef)(null), [n, a] = (0, import_react.useState)({}), [B, r] = (0, import_react.useState)({}), s = (0, import_react.useCallback)(async (A, i) => {
			...
			void 0 !== A.srcObject ? A.srcObject = t : void 0 !== A.mozSrcObject ? A.mozSrcObject = t : window.URL.createObjectURL ? A.src = window.URL.createObjectURL(t) : window.webkitURL ? A.src = window.webkitURL.createObjectURL(t) : A.src = t.id, await Promise.race([A.play(), new Promise((A) => setTimeout(A, 3e3)).then(() => {
		...
		}, []), C = (0, import_react.useCallback)(async (A, i) => {
		...
		}, []), c = (0, import_react.useCallback)(async (o, { constraints: g, restart: i = !1 }) => {
			let t = null;
		...
		}, [s, C]), E = (0, import_react.useCallback)(async () => {
		...
		}, [C]), h = (0, import_react.useCallback)(async (A) => {
			const o = g.current;
			if (!o) throw new Error("No active video track found.");
			{
				A.advanced?.[0].zoom && o.getCapabilities().torch && await o.applyConstraints({ advanced: [{ torch: !1 }] }), await o.applyConstraints(A);
	...
	}(), U = (0, import_react.useRef)(x), Z = (0, import_react.useRef)(T), W = (0, import_react.useRef)(N.tracker);
	...
	const { startScanning: b, stopScanning: O } = function(o) {
		const { videoElementRef: g, onScan: t, onFound: n, retryDelay: a = 100, scanDelay: B = 0, formats: r = [], allowMultiple: s = !1, sound: C = !0 } = o, c = (0, import_react.useRef)(new bo({ formats: r })), E = (0, import_react.useRef)(null), h = (0, import_react.useRef)(null);
		(0, import_react.useEffect)(() => {
			c.current = new bo({ formats: r });
		...
		const q = (0, import_react.useCallback)((A) => async (o) => {
	...
	const S = (0, import_react.useMemo)(() => P.shouldStream && y, [P.shouldStream, y]);
	return (0, import_react.useEffect)(() => {
		if (S) {
			...
			u(R.current);
			if (null == V.current) throw new Error("shouldScan effect should only be triggered when component is mounted. Thus video element is defined");
			b();
		}
		return () => {
			O();
		...
		children: [
			...
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [N.finder && (0, import_jsx_runtime.jsx)(p, {
					scanning: y,
...
function y() {
	const [A, o] = (0, import_react.useState)([]), g = (0, import_react.useCallback)(async () => (await navigator.mediaDevices.enumerateDevices()).filter((A) => "videoinput" === A.kind), []);
	return (0, import_react.useEffect)(() => {
		(async () => {
			o(await g());
		})();
